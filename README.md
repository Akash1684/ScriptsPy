...
* [autopot.py](https://github.com/Akash1684/ScriptsPy/blob/master/autopot.py) : Automating the signing-in procedure of internet access and subsequently opening the wifi hotspot (solving the boring manual process).
